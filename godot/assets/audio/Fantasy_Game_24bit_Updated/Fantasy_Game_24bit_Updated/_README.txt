Fantasy Game version 1.0 06/31/2017
Fantasy Game version 1.1 06/21/2021

Package Contents
----------------

1) This README file
2) files Fantasy Game
3) Content Listing - _Fantasy Game
4) 625 number of audio assets in .wav format
5) 625 number of audio assets in both 24 bit 96k .wav
...
Fantasy Game is a Sound library created and produced by Epic Stock Media. The library presents a diverse set of audio assets that are particularly useful to game and software developers, sound designers and producers. 
...
Playback of files can be achieved with modern digital audio workstations, game and software development platforms and with any device that can process the included 16bit 44.1k and/or 24bit 96k format audio files. 


Copyright & End User License Agreement
--------------------------------------

License and use of this product is subject to the Epic Stock Media EULA. The EULA is included in this package and can also be found at: https://epicstockmedia.com/licensing-agreement/ - This product is protected by international copyright law. All content is copyright 2021 © Epic Stock Media - All trademarks and trade names are the property of their respective owners.
